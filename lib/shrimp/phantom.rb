...
module Shrimp
  ...
  class Phantom
    ...
    def cmd
      ...
      [Shrimp.configuration.phantomjs, command_config_file, SCRIPT_FILE, @source.to_s, @outfile, format, zoom, margin, orientation, cookie_file, rendering_time, timeout, viewport_width, viewport_height, '> ~/access.log' ].join(" ")
    end
